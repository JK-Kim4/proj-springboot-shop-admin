CREATE TABLE `MAGAZINE` (
	...
	`QUARTERLY_CATEGORY_SEQ`	INT	NOT NULL  DEFAULT 1 COMMENT '계간지 카테고리 고유 번호',
	`MAGAZINE_TITLE`			VARCHAR(150)	NULL COMMENT '계간지 제목', 
	`MAGAZINE_CONTENT`			TEXT COMMENT '게간지 본문',
	`MAGAZINE_VOLUME`			INT	NULL COMMENT '계간지 출간 호수',
	`MAGAZINE_YEAR`				INT NOT NULL DEFAULT (YEAR(NOW())) COMMENT '계간지 출간 년도',
	`MAGAZINE_SEASON`			VARCHAR(50)	NULL COMMENT '계간지 출간 계절',
	`MAGAZINE_THUMBNAIL_IMAGE`	VARCHAR(300)	NULL COMMENT '2' COMMENT '계간지 섬네일 이미지',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='계간지';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='계간지-기사';
